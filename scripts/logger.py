...
class Logger(metaclass=Singleton):
    def __init__(self):
        ...
        info_formatter = AutoGptFormatter('%(levelname)s %(title)s %(message_no_color)s')
        ...
        error_formatter = AutoGptFormatter(
            '%(levelname)s %(module)s:%(funcName)s:%(lineno)d %(title)s %(message_no_color)s')
    ...
    def typewriter_log(
        ...
        self.typing_logger.log(level, content, extra={'title': title})
