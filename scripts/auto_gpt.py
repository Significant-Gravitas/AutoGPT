...
class AutoGPT:
    def __init__(
        ...
        if continous_mode:
            ...
            self.cfg.set_continuous_mode(continous_mode)
        if speak_mode:
            print_to_console("Speak Mode: ", Fore.GREEN, "ENABLED")
            self.cfg.set_speak_mode(speak_mode)
        if gpt3only_mode:
            print_to_console("GPT3.5 Only Mode: ", Fore.GREEN, "ENABLED")
            self.cfg.set_smart_llm_model(self.cfg.fast_llm_model)
        if debug_mode:
            self.cfg.set_debug_mode(debug_mode)
        ...
        print("full_message_history", self.full_message_history)
