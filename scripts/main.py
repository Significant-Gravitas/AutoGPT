...
def load_variables(config_file="config.yaml"):
    ...
    prompt = get_prompt()
    prompt_start = """Your decisions must always be made independently without seeking user assistance. Use your strengths as an LLM and pursue strategies with no legal complications."""
