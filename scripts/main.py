...
def construct_prompt(interactive_input=True):
...
def prompt_user():
    ...
    config = Agent(ai_name, ai_role, ai_goals)
    return config
...
if __name__ == '__main__':
    ...
    active_agent = ActiveAgent(cfg, prompt, memory, full_message_history, result, next_action_count, user_input)
    active_agent.start_loop()
