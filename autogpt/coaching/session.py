...
class CoachingSession:
    ...
    def _parse_summary_json(self, raw: str) -> tuple[WeeklyLog, str]:
        ...
        try:
            ...
            logger.warning(
                "session=%s _parse_summary_json: JSON decode failed. raw_snippet=%r",
                self.session_id,
                raw[:200],
            )
    ...
    def _parse_okr_changes(self, raw: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.warning(
                "session=%s _parse_okr_changes: JSON decode failed",
                self.session_id,
            )
            return []
    ...
    def is_expired(self) -> bool:
        """Return True if this session has been idle longer than SESSION_TTL."""
