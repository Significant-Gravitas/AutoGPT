        ...
        while True:
            ...
            if not cfg.continuous_mode and self.next_action_count == 0:
                ...
                logger.info(
                    ...
                    f"{Fore.LIGHTBLACK_EX}{Back.RED}{Style.DIM}<Continuous>>> ({cfg.authorise_key} -<number>){Style.RESET_ALL}      [I need your clothes, your boots, and your continuous cmds]\n"  # noqa: E501
                    f"{Fore.GREEN}{Back.BLACK}{Style.DIM}<Feedback>>> ({cfg.feedback_key}) <trigger>){Style.RESET_ALL}                   [Desire is irrelevant. I am a machine]\n"  # noqa: E501
                    f"{Fore.WHITE}{Back.BLACK}{Style.DIM}<Exit|Input>>> ({cfg.exit_key}) <input>){Style.RESET_ALL}                   [Hasta la vista, baby] or ['Talk to the hand]\n"  # noqa: E501
