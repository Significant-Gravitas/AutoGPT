# 1st section of the code (Tokens 1,301 Characters 3300)
import asyncio
import json
import platform
import sys
...
# 2nd section of the code, (Tokens 1,850 Characters 3733)
class APIRequestor:
    def __init__(
        self,
        key=None,
    ...
    async def arequest(
        ...
        pass
# 3rd section of the code, (Tokens 194 Characters 411)
    @overload
    async def arequest(
        self,
        method,
    ...
    async def arequest(
        ...
        if got_stream:
            ...
            await ctx.__aexit__(None, None, None)
            return resp, got_stream, self.api_key
# 4th section of the code, (Tokens 1,977 Characters 3883)
    ...
    def _validate_headers(
        ...
        return headers
# 5th section of the code, (Tokens 696 Characters 1427)
    ...
    def request_raw(
        ...
        *,
        ...
        return result
# 6th section of the code, (Tokens 1,599 Characters 3239)
...
# 7th section of the code, (Tokens 735 Characters 1587)
