...
def scrape_text_with_selenium(url: str) -> tuple[WebDriver, str]:
    ...
    options.add_argument(
        "user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.5615.49 Safari/537.36"  # noqa: E501
    )
...
def summarize_memorize_webpage(url: str, text: str, question: str, driver: Optional[WebDriver] = None) -> str:
