...
def construct_main_agent_config() -> ProjectConfigBroker:
    ...
    if CFG.skip_reprompt and config.agent_name:
        ...
        logger.typewriter_log("Goals:", Fore.GREEN, f"{config.agent_goals}")
        ...
        logger.typewriter_log(
            "Welcome back! ",
            Fore.GREEN,
            f"Would you like me to return to being {config.agent_name}?",
            speak_text=True,
        )
...
Continue (y/n): """
    ...
    if not config.agent_name:
        config = prompt_user()
        config.save(CFG.agent_settings_file)
    ...
    # Name
    logger.typewriter_log("Name:", Fore.GREEN, config.agent_name, speak_text=False)
    # Role
    logger.typewriter_log("Role:", Fore.GREEN, config.agent_role, speak_text=False)
    # Goals
    logger.typewriter_log("Goals:", Fore.GREEN, "", speak_text=False)
    for goal in config.agent_goals:
