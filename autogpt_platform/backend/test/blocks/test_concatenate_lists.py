...
async def test_concatenate_lists_manual():
    ...
    result = []
    # Type ignore: We're intentionally testing with invalid input to verify runtime validation
    async for output_name, output_data in block.run(invalid_input):  # type: ignore[arg-type]
        result.append((output_name, output_data))
