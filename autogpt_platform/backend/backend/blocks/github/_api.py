...
from backend.blocks.github._auth import GithubCredentials, GithubCredentialsAPIOnly
...
def get_api(
    credentials: GithubCredentials | GithubCredentialsAPIOnly, convert_urls: bool = True
) -> Requests:
    return Requests(
