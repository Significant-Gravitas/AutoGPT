"""Tests for ToolOrchestratorBlock compatibility with the OpenAI Responses API.

The ToolOrchestratorBlock manages conversation history in the Chat Completions
...
from backend.blocks.tool_orchestrator import (
...
async def test_agent_mode_conversation_valid_for_responses_api():
    ...
    with patch("backend.blocks.llm.llm_call", llm_mock), patch.object(
        ...
        inp = ToolOrchestratorBlock.Input(
            prompt="Improve this",
