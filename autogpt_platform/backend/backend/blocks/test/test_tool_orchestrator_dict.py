...
@pytest.mark.asyncio
async def test_tool_orchestrator_handles_dynamic_dict_fields():
    """Test Tool Orchestrator can handle dynamic dictionary fields (_#_) for any block"""
    ...
    signature = await ToolOrchestratorBlock._create_block_function_signature(
...
@pytest.mark.asyncio
async def test_tool_orchestrator_handles_dynamic_list_fields():
    """Test Tool Orchestrator can handle dynamic list fields (_$_) for any block"""
