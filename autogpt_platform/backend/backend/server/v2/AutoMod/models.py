...
class ModerationResult(BaseModel):
    ...
    decision: str = Field(..., description="Moderation decision: 'approved', 'rejected', 'flagged'")
...
class AutoModResponse(BaseModel):
    ...
    status: str = Field(..., description="Overall status: 'approved', 'rejected', 'flagged', 'pending'")
...
class ModerationConfig(BaseModel):
    ...
    api_url: str = Field(
        default="", 
        description="AutoMod API base URL"
    )
