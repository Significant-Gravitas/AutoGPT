...
class ScheduleFollowupTool(BaseTool):
    ...
    def description(self) -> str:
        return (
            ...
            "its full history. Every combination is valid — a recurring "
            "follow-up pinned to one thread is how a daily routine "
            "remembers what it said yesterday, and is usually what "
            "somebody means by a standing digest. After calling this "
