"""CoPilot service — shared helpers and baseline LLM fallback.

This module contains:
- Shared helpers used by the SDK service (system prompt, title generation, etc.)
- A simple single-call LLM baseline for testing when SDK is disabled.
"""
