...
if TYPE_CHECKING:
    from .service import CopilotResult as CopilotResult
    from .service import collect_copilot_response as collect_copilot_response
...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    "CopilotResult": (".service", "CopilotResult"),
    "collect_copilot_response": (".service", "collect_copilot_response"),
