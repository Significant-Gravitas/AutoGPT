...
class TestAssignResources:
    ...
    @pytest.mark.asyncio
    async def test_listing_version_backfill_uses_graph_scope(self, mock_prisma):
        mock_prisma.execute_raw = AsyncMock(return_value=0)
        ...
        version_sql = next(
            ...
            if 'UPDATE "StoreListingVersion"' in call.args[0]
        )
        assert '"organizationId" = o."id"' in version_sql
