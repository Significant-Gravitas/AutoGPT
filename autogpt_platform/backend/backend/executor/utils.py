...
async def add_graph_execution(
    ...
    *,
    ...
    copilot_tree: Optional[TurnEnvelope] = None,
...
async def _add_graph_execution(
    ...
    *,
    ...
    Args:
        ...
        copilot_tree: The copilot turn's tree, when a turn started this run.
            Carried in the execution payload because contextvars cannot reach
            the executor process, so a nested AutoPilotBlock turn stays inside
            the tree that spawned it instead of rooting an unbounded one.
