...
from backend.data.execution import GraphExecutionWithNodes, RedisExecutionEventBus
...
def add_graph_execution(
    ...
    graph_credentials_input: Optional[dict[str, CredentialsMetaInput]] = None,
    ...
    Args:
        ...
        inputs (BlockInput): The input data for the graph execution.
        user_id (str): The ID of the user executing the graph.
    ...
    node_credentials_input_map = (
        make_node_credentials_input_map(graph, graph_credentials_input)
        if graph_credentials_input
        else None
    )
