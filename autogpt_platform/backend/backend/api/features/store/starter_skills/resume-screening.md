...
triggers: ["screen resumes", "review applicants", "resume shortlist", "candidate screen", "application review"]
version: "1"
---
...
Return one evidence matrix per candidate, open verification questions, and a process-quality note if the rubric yields too many unknowns. Do not rank candidates or recommend advance, reject, hire, or compensation decisions. The named human owner decides and records the reason.
