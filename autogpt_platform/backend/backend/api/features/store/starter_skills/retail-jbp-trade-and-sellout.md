---
name: "retail-jbp-trade-and-sellout"
description: "Use when selling through retailers or distributors where joint plans, trade spend, and in-store execution decide the number."
triggers: ["joint business plan", "trade spend", "sell-out", "promo calendar", "post-event analysis", "shelf audit", "chargeback dispute"]
version: "1"
---
...
Build or refresh the joint and customer business plan: shared growth
target, the sell-in story that earns the order, the sell-out plan that
earns the reorder, and dated commitments on both sides with compliance
tracking.
...
Close every promo with post-event analysis before the next calendar locks:
...
Hold the shelf standard: assortment, merchandising, and visibility targets
per store, verified by audits not by hope. Failed audits get a dated
...
Output: joint business plan with dated commitments, trade budget with
promo ROI, store-level sell-out read, post-event analysis feeding the next
calendar, audit corrections, and a receivables and dispute log.
