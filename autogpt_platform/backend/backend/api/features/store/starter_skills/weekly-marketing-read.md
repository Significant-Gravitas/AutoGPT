...
Each headline figure against its plan target: engagement at the top, conversion
in the middle, pipeline and revenue at the bottom. Check the four-week rolling
average before you call anything a trend. Attribution windows of 7 to 14 days
distort the most recent week of ROAS and CPA, so flag those figures as
preliminary.
...
Roll the weeks into one read against plan: the trend per headline metric, what
compounded, and what to change. Read the quarter the same way.
