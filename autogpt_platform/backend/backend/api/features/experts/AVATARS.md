...
Team and Marketplace use the category hex values from the source design as 24% tints mixed with white. Body hues stay independent of topic, as requested for easier recognition. Otto alone uses mineral lavender (#B6A4C8). Team covers use the same plain topic tint. The sidebar adds a circular 1px #e3e3e3 border. Managed identities use their existing transparent cutouts on tinted surfaces.
