...
EXPECTED_ROSTER_ROUTINES: set[tuple[str, str]] = {
    ...
    ("Blake", "friday-pipeline-recap"),
    ("Blake", "monday-list-top-up"),
    ("Blake", "monday-team-pipeline-inspection"),
    ("Blake", "monthly-win-loss-review"),
    ("Blake", "wednesday-forecast-and-deal-inspection"),
    ("Blake", "weekday-prospecting-batch"),
