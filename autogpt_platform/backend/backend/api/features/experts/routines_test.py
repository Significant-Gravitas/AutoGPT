...
EXPECTED_ROSTER_ROUTINES: set[tuple[str, str]] = {
    ...
    ("Casey", "callback-and-queue-sweep"),
    ("Casey", "escalation-and-sla-watch"),
    ("Casey", "knowledge-and-staffing-pulse"),
    ("Casey", "open-case-sweep"),
    ...
    ("Priya", "partner-portfolio-review"),
    ("Priya", "partner-qbr-countdown"),
    ("Priya", "weekly-partner-pulse"),
    ("Remy", "lifecycle-performance-read"),
    ("Sasha", "friday-pipeline-recap"),
    ("Sasha", "monday-list-top-up"),
    ("Sasha", "monday-team-pipeline-inspection"),
    ("Sasha", "monthly-win-loss-review"),
    ("Sasha", "wednesday-forecast-and-deal-inspection"),
    ("Sasha", "weekday-prospecting-batch"),
