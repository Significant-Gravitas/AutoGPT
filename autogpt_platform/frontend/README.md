...
> [!NOTE]
> You don't need to run the OpenAPI commands below to run the Front-end. You might need to run when adding/modifying endpoints in the Back-end, however, the CI is setup to let you know 👍🏽 (it'll pull the latest OpenAPI spec, generate the clients and run the types on the Front-end to check everything works)
