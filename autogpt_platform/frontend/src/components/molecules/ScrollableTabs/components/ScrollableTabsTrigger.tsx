  ...
  function ScrollableTabsTrigger(
    ...
    return (
      <button
        ...
        onClick={handleClick}
        className={cn(
          "relative inline-flex items-center justify-center px-3 py-3 font-sans text-[0.875rem] leading-6 font-medium whitespace-nowrap text-zinc-700 transition-all focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-2 focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50",
