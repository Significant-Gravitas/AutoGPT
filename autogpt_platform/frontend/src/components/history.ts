...
import { CustomEdgeData } from "../app/(platform)/build/components/CustomEdge/CustomEdge";
import { CustomNodeData } from "../app/(platform)/build/components/CustomNode/CustomNode";
