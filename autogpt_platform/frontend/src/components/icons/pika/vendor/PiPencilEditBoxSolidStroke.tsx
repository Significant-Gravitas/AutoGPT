...
/**
 * PiPencilEditBoxSolidStroke icon from the stroke style in editing category.
 */
interface PiPencilEditBoxSolidStrokeProps
...
export default function PiPencilEditBoxSolidStroke({
  size = 24,
  color,
  className,
  ariaLabel = "pencil-edit-box icon",
  ...props
}: PiPencilEditBoxSolidStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
