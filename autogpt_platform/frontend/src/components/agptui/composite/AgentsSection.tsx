  ...
  return (
    <div className="flex flex-col items-center justify-center py-4 lg:py-8">
      <div className="w-full max-w-[1360px]">
        <div className="font-poppins decoration-skip-ink-none mb-8 text-left text-[18px] leading-7 font-[600] text-[#282828] underline-offset-[from-font] dark:text-neutral-200">
          {sectionTitle}
        </div>
            ...
            >
              <CarouselContent>
                {displayedAgents.map((agent, index) => (
                  <CarouselItem key={index} className="max-w-68 min-w-64">
                    <StoreCard
