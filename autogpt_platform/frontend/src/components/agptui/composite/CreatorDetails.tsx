    ...
    <div className="w-full max-w-[1359px]">
      ...
      <div className="flex flex-col gap-8 lg:flex-row">
        <div className="w-full lg:w-1/2">
          <div className="mb-8">
            <h1 className="font-neue mb-2 text-5xl font-medium leading-9 tracking-wide text-[#272727]">
              {name}
            </h1>
            <p className="font-neue text-[19px] font-medium leading-9 tracking-tight text-[#878787]">
              @{username}
            </p>
          </div>
          <div className="mb-8">
          ...
          {Object.keys(otherLinks).length > 0 && (
            <div>
              <h2 className="font-neue mb-2 text-lg font-medium leading-9 tracking-tight text-[#282828]">
                Other links
              </h2>
              <div className="flex flex-wrap gap-4">
                {Object.entries(otherLinks).slice(0, 5).map(([key, url]) => (
                  <a
                    key={key}
                    href={url}
        ...
        {/* Right Hand Side */}
        <div className="w-full lg:w-1/2">
          <p className="font-neue mb-8 text-3xl font-normal leading-[39px] tracking-tight text-[#474747]">
          ...
          <div>
            <h2 className="font-neue mb-4 text-lg font-medium leading-9 tracking-tight text-[#282828]">
              Top categories
            </h2>
