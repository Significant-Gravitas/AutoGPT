...
const buttonVariants = cva(
  "inline-flex items-center whitespace-nowrap rounded-[80px] text-xl font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-neutral-300 font-neue leading-9 tracking-tight",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        icon: "h-10 w-10",
        card: "h-12 p-5 rounded-xl justify-center text-lg",
      },
    },
    defaultVariants: {
      variant: "default",
