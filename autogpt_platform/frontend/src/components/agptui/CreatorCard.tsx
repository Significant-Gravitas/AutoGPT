...
export const CreatorCard: React.FC<CreatorCardProps> = ({
  ...
  return (
    <div
      className={`h-[264px] w-full px-[18px] pt-6 pb-5 ${backgroundColor} inline-flex cursor-pointer flex-col items-start justify-start gap-3.5 rounded-[26px] transition-all duration-200 hover:brightness-95`}
      onClick={onClick}
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="font-geist text-sm leading-normal font-normal text-neutral-600 dark:text-neutral-400">
          {bio}
        </p>
        <div className="font-geist text-lg leading-7 font-semibold text-neutral-800 dark:text-neutral-200">
