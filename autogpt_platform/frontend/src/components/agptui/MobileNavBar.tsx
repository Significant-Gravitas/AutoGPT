  ...
  const content = (
    <div className="inline-flex w-full items-center justify-start gap-4 hover:rounded hover:bg-[#e0e0e0] dark:hover:bg-[#3a3a3a]">
      ...
      <div className="relative">
        <div
          className={`text-base font-normal leading-7 text-[#474747] dark:text-[#cfcfcf] ${isActive ? "font-semibold text-[#272727] dark:text-[#ffffff]" : "text-[#474747] dark:text-[#cfcfcf]"}`}
        >
          {text}
        </div>
        {isActive && (
              ...
              >
                <div className="mb-4 inline-flex w-full items-end justify-start gap-4">
                  ...
                  <div className="relative h-14 w-full">
                    ...
                    <div className="absolute left-0 top-6 text-base font-normal leading-7 text-[#474747] dark:text-[#cfcfcf]">
