      ...
      >
        ...
        <div className="inline-flex items-center justify-start gap-4 self-stretch">
          ...
          <div className="relative h-[47px] w-[173px]">
            <div className="absolute top-0 left-0 font-['Geist'] text-base leading-7 font-semibold text-white dark:text-neutral-200">
              {userName}
            </div>
            <div className="absolute top-[23px] left-0 font-['Geist'] text-base leading-normal font-normal text-white dark:text-neutral-400">
              {userEmail}
            </div>
          </div>
        </div>
                ...
                if (item.href) {
                  return (
                    ...
                    >
                      ...
                      <div className="font-['Geist'] text-base leading-normal font-medium text-neutral-800 dark:text-neutral-200">
                        {item.text}
                      </div>
                    </Link>
                  );
