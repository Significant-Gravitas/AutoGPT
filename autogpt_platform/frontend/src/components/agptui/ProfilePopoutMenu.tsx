      ...
      >
        ...
        <div className="inline-flex items-center justify-start gap-4 self-stretch">
          ...
          <div className="relative h-[47px] w-[173px]">
            <div className="absolute left-0 top-0 text-base font-semibold leading-7 text-white dark:text-neutral-200">
              {userName}
            </div>
            <div className="absolute left-0 top-[23px] text-base font-normal leading-normal text-white dark:text-neutral-400">
              {userEmail}
            </div>
          </div>
        </div>
