  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={`flex-grow border-none bg-transparent ${textColor} text-lg font-normal leading-[2.25rem] tracking-tight md:text-xl placeholder:${placeholderColor} focus:outline-none`}
