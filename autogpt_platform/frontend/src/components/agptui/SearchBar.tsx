  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={`grow border-none bg-transparent ${textColor} font-['Geist'] text-lg leading-[2.25rem] font-normal tracking-tight md:text-xl placeholder:${placeholderColor} focus:outline-hidden`}
