...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn(
      "font-poppins text-sm font-semibold [&+div]:text-xs",
      className,
    )}
    {...props}
  />
