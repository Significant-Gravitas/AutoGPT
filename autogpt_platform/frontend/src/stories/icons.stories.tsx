...
<User className="size-4 md:size-5 lg:size-6" />`}
      ...
      <div className="space-y-8">
        <div>
          ...
          <Text variant="body" className="mb-6 text-zinc-600">
            Guidelines for transitioning from Lucide to Phosphor icons in
            existing components.
          </Text>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-lg border border-red-200 bg-red-50 p-4">
            ...
            <StoryCode
              code={`import { User, Settings, Menu } from "lucide-react";
...
<Menu strokeWidth={1.5} />`}
          ...
          <div className="rounded-lg border border-green-200 bg-green-50 p-4">
            <Text
              variant="body-medium"
              className="mb-2 font-semibold text-green-800"
            >
              ✅ New (Phosphor)
            </Text>
            <StoryCode
              code={`import { User, Gear, List } from "@phosphor-icons/react";
...
<List weight="light" />`}
        ...
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
          ...
          <ul className="ml-4 list-disc space-y-1 text-blue-700">
            <li>Replace Lucide imports with equivalent Phosphor icons</li>
            <li>
              Update size props: Lucide uses className=&quot;h-4 w-4&quot;,
              Phosphor uses size={16}
            </li>
            <li>Use weight prop instead of strokeWidth for line thickness</li>
            <li>Check icon names - some may differ between libraries</li>
            <li>Test accessibility with screen readers after migration</li>
          </ul>
        </div>
      </div>
    </div>
