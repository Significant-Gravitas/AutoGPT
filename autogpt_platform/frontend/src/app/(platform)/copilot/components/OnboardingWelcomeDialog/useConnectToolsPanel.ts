...
// most people wire up first anyway. Ordered; padded from the full list if
// any of them are missing from this deployment's registry.
...
export function useConnectToolsPanel() {
  ...
  function fallbackProviders(all: ConnectableProvider[]) {
