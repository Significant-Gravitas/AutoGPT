  ...
  const query = useGetExpert(artifact.id ?? "", {
    query: {
      ...
      queryKey: getTeamScopedQueryKey(
        getGetExpertQueryKey(artifact.id ?? ""),
        organizationId,
        teamId,
      ),
    },
...
export function ExpertArtifactContent({
  expert: artifact,
  organizationId = null,
  teamId = null,
}: Props) {
  const expert = useCharterFallback(artifact, organizationId, teamId);
