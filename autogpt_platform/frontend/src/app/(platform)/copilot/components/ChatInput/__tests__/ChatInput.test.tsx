...
describe("ChatInput advanced composer controls", () => {
  it("does not render advanced controls when the flag is disabled", () => {
    mockFlagValue = false;
    render(<ChatInput onSend={mockOnSend} />);
    expect(screen.queryByLabelText(/switch to/i)).toBeNull();
  });

  it("renders the model toggle when the flag is enabled", () => {
    mockFlagValue = true;
    render(<ChatInput onSend={mockOnSend} />);
    expect(screen.getByLabelText(/switch to advanced model/i)).toBeDefined();
  });

  it("shows the Codex model control backed by the model catalog", () => {
    mockFlagValue = true;
  ...
  it("hides the model toggle when streaming", () => {
    mockFlagValue = true;
  ...
  it("shows the model toggle between turns of an existing session", () => {
    mockFlagValue = true;
