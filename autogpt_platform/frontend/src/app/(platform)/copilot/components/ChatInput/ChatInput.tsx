    ...
    <form onSubmit={handleSubmit} className={cn("relative flex-1", className)}>
      <InputGroup
        className={cn(
          ...
          // In an active session the input docks to the bottom of the chat
          // card as a flush bar — no rounding/shadow, just a top hairline.
          hasSession &&
            "!rounded-none border-0 border-t border-neutral-200 pt-4 shadow-none",
          isRecording &&
