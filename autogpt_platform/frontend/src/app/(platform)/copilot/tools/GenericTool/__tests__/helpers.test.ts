...
describe("formatToolName", () => {
  ...
  it("uses friendly display name for subtask tools", () => {
    expect(formatToolName("run_sub_session")).toBe("Subtask");
    expect(formatToolName("get_sub_session_result")).toBe("Subtask result");
  });
