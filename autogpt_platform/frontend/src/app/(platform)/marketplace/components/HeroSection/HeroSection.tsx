  ...
  return (
    <div className="mb-16 mt-10 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-3xl">
        <h1 className="mb-2 text-center text-3xl font-semibold tracking-[-0.02em] text-zinc-900 md:text-4xl">
          AI experts and workflows, built for{" "}
