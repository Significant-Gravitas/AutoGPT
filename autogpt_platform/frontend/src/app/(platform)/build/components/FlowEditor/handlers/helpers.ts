...
// Helper to get display type and color for schema types
export const getTypeDisplayInfo = (schema: any) => {
  // Check for special string formats first
  ...
  // Map schema types to display types (similar to old builder)
  ...
  // Use the same color mapping as the old builder
