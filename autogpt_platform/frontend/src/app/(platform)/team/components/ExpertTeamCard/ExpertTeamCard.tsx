        ...
        <div className="flex w-full items-start gap-3 px-2">
          <span className="relative z-10 -mt-12 ml-1 block shrink-0">
            {isUploadedAvatar(expert.avatar_url) ? (
              <Avatar className="size-[5.5rem] rounded-full border border-zinc-800 ring-4 ring-white">
                <AvatarImage
              ...
              <span className="flex size-[5.5rem] items-center justify-center rounded-full border border-zinc-800 bg-white ring-4 ring-white">
                <BotAvatar
