    ...
    <div className="flex items-center gap-1 rounded-full border border-black/5 bg-white/60 p-1.5 shadow-[0_1px_2px_rgba(0,0,0,0.04),0_12px_32px_-8px_rgba(0,0,0,0.12)] backdrop-blur-xl">
      <Tooltip>
        <TooltipTrigger asChild>
          <div className="[&_button:hover]:bg-black/5 [&_button]:flex [&_button]:h-8 [&_button]:w-8 [&_button]:items-center [&_button]:justify-center [&_button]:rounded-full [&_button]:bg-transparent [&_button]:p-0 [&_button]:transition-colors [&_svg]:!size-6">
            <AgentActivityDropdown />
          </div>
        </TooltipTrigger>
        <TooltipContent side="bottom">Agent activity</TooltipContent>
      </Tooltip>
      <Tooltip>
        <TooltipTrigger asChild>
          <div>
        ...
        <TooltipContent side="bottom">Today&apos;s usage</TooltipContent>
      </Tooltip>
      {profile && (
        <Tooltip>
          <TooltipTrigger asChild>
