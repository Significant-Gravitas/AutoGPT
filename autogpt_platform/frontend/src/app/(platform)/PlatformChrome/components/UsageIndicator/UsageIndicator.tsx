...
import { GaugeIcon } from "@/components/atoms/AGPTIcon/icons";
    ...
    <UsagePopover
      ...
      trigger={
        <button
          ...
          aria-label={label}
          title={label}
          className="relative flex size-7 items-center justify-center rounded-xl border border-zinc-200 bg-zinc-100 p-0 transition-colors hover:bg-zinc-200"
        >
