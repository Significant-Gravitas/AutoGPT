      ...
      {transaction.parent_execution_id && (
        <RelatedExecution
          execution={{
            ...
            execution_available: !!transaction.parent_execution_url,
            agent_url: transaction.parent_agent_url,
            execution_url: transaction.parent_execution_url,
          }}
...
function RelatedExecution({
  ...
  const href = execution.execution_url ?? null;
  return (
