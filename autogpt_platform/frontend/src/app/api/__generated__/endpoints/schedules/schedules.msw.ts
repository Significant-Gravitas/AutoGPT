...
export const getGetV1ListExecutionSchedulesForAGraphResponseMock =
  (): GraphExecutionJobInfo[] =>
    Array.from(
      ...
      schedule_id: faker.helpers.arrayElement([
      ...
      agent_name: faker.helpers.arrayElement([
        faker.helpers.arrayElement([
          faker.string.alpha({ length: { min: 10, max: 20 } }),
          null,
        ]),
...
export const getGetV1ListExecutionSchedulesForAGraphResponseMock401 = (
...
export const getPostV1CreateExecutionScheduleResponseMock401 = (
  overrideResponse: Partial<HTTP401NotAuthenticatedErrorResponse> = {},
): HTTP401NotAuthenticatedErrorResponse => ({
  detail: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
...
export const getGetV1ListExecutionSchedulesForAUserResponseMock401 = (
  overrideResponse: Partial<HTTP401NotAuthenticatedErrorResponse> = {},
): HTTP401NotAuthenticatedErrorResponse => ({
  detail: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
...
export const getDeleteV1DeleteExecutionScheduleResponseMock401 = (
  overrideResponse: Partial<HTTP401NotAuthenticatedErrorResponse> = {},
): HTTP401NotAuthenticatedErrorResponse => ({
  detail: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
...
export const getGetV1ListExecutionSchedulesForAGraphMockHandler = (
  ...
  return http.get(
    "http://localhost:3000/api/proxy/api/graphs/:graphId/schedules",
    async (info) => {
      await delay(0);
...
export const getGetV1ListExecutionSchedulesForAGraphMockHandler401 = (
  overrideResponse?:
    | HTTP401NotAuthenticatedErrorResponse
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
        ...
        JSON.stringify(
          overrideResponse !== undefined
            ? typeof overrideResponse === "function"
              ? await overrideResponse(info)
              : overrideResponse
            : getGetV1ListExecutionSchedulesForAGraphResponseMock401(),
        ),
...
export const getPostV1CreateExecutionScheduleMockHandler401 = (
  overrideResponse?:
    | HTTP401NotAuthenticatedErrorResponse
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
        ...
        JSON.stringify(
          overrideResponse !== undefined
            ? typeof overrideResponse === "function"
              ? await overrideResponse(info)
              : overrideResponse
            : getPostV1CreateExecutionScheduleResponseMock401(),
        ),
        { status: 401, headers: { "Content-Type": "application/json" } },
      );
    },
...
export const getGetV1ListExecutionSchedulesForAUserMockHandler = (
  ...
  return http.get(
    "http://localhost:3000/api/proxy/api/schedules",
    async (info) => {
      await delay(0);
...
export const getGetV1ListExecutionSchedulesForAUserMockHandler401 = (
  overrideResponse?:
    | HTTP401NotAuthenticatedErrorResponse
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
        ...
        JSON.stringify(
          overrideResponse !== undefined
            ? typeof overrideResponse === "function"
              ? await overrideResponse(info)
              : overrideResponse
            : getGetV1ListExecutionSchedulesForAUserResponseMock401(),
        ),
        { status: 401, headers: { "Content-Type": "application/json" } },
      );
    },
...
export const getDeleteV1DeleteExecutionScheduleMockHandler = (
  ...
  return http.delete(
    "http://localhost:3000/api/proxy/api/schedules/:scheduleId",
    async (info) => {
      await delay(0);
...
export const getDeleteV1DeleteExecutionScheduleMockHandler401 = (
  overrideResponse?:
    | HTTP401NotAuthenticatedErrorResponse
    | ((
        info: Parameters<Parameters<typeof http.delete>[1]>[0],
        ...
        JSON.stringify(
          overrideResponse !== undefined
            ? typeof overrideResponse === "function"
              ? await overrideResponse(info)
              : overrideResponse
            : getDeleteV1DeleteExecutionScheduleResponseMock401(),
        ),
        { status: 401, headers: { "Content-Type": "application/json" } },
      );
    },
