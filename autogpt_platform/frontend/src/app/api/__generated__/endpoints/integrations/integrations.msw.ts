...
import type { GetV1GetProvidersDetails200 } from "../../models/getV1GetProvidersDetails200";
...
export const getGetV1GetProvidersDetailsResponseMock =
  (): GetV1GetProvidersDetails200 => ({
    [faker.string.alphanumeric(5)]: {
      ...
      has_oauth: faker.datatype.boolean(),
      has_webhooks: faker.datatype.boolean(),
      supported_credential_types: faker.helpers.arrayElement([
...
export const getGetV1GetProvidersDetailsResponseMock200 =
  (): GetV1GetProvidersDetails200 => ({
    [faker.string.alphanumeric(5)]: {
      name: faker.string.alpha({ length: { min: 10, max: 20 } }),
      source: faker.helpers.arrayElement([
...
export const getGetV1ListProvidersMockHandler = (
  ...
  return http.get("*/api/integrations/providers", async (info) => {
    await delay(1000);
...
export const getGetV1GetProvidersDetailsMockHandler = (
  overrideResponse?:
    | GetV1GetProvidersDetails200
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) => Promise<GetV1GetProvidersDetails200> | GetV1GetProvidersDetails200),
) => {
  return http.get("*/api/integrations/providers/details", async (info) => {
    await delay(1000);
      ...
      JSON.stringify(
        overrideResponse !== undefined
          ? typeof overrideResponse === "function"
            ? await overrideResponse(info)
            : overrideResponse
          : getGetV1GetProvidersDetailsResponseMock(),
      ),
      { status: 200, headers: { "Content-Type": "application/json" } },
    );
  });
...
export const getGetV1GetProvidersDetailsMockHandler200 = (
  overrideResponse?:
    | GetV1GetProvidersDetails200
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ...
      JSON.stringify(
        overrideResponse !== undefined
          ? typeof overrideResponse === "function"
            ? await overrideResponse(info)
            : overrideResponse
          : getGetV1GetProvidersDetailsResponseMock200(),
      ),
      { status: 200, headers: { "Content-Type": "application/json" } },
    );
  });
...
export const getIntegrationsMock = () => [
  ...
  getGetV1GetProvidersDetailsMockHandler(),
];
