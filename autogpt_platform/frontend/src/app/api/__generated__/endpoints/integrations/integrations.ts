...
export type getV1LoginResponse401 = {
...
export type GetV1LoginQueryResult = NonNullable<
  Awaited<ReturnType<typeof getV1Login>>
>;
export type GetV1LoginQueryError =
...
export type postV1CallbackResponse401 = {
  data: HTTP401NotAuthenticatedErrorResponse;
  status: 401;
};
...
export type PostV1CallbackMutationError =
  | HTTP401NotAuthenticatedErrorResponse
  | HTTPValidationError;
...
export type getV1GetCredentialResponse401 = {
  data: HTTP401NotAuthenticatedErrorResponse;
  status: 401;
};
...
export type GetV1GetCredentialQueryResult = NonNullable<
  Awaited<ReturnType<typeof getV1GetCredential>>
>;
export type GetV1GetCredentialQueryError =
  | HTTP401NotAuthenticatedErrorResponse
  | HTTPValidationError;
