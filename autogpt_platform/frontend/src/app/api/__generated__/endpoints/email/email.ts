...
export type postV1HandlePostmarkEmailWebhooksResponseSuccess =
  postV1HandlePostmarkEmailWebhooksResponse200 & {
    headers: Headers;
  };
export type postV1HandlePostmarkEmailWebhooksResponseError =
  postV1HandlePostmarkEmailWebhooksResponse422 & {
    headers: Headers;
  };

export type postV1HandlePostmarkEmailWebhooksResponse =
  | postV1HandlePostmarkEmailWebhooksResponseSuccess
  | postV1HandlePostmarkEmailWebhooksResponseError;
...
export type postV1OneClickEmailUnsubscribeResponseSuccess =
  postV1OneClickEmailUnsubscribeResponse200 & {
    headers: Headers;
  };
export type postV1OneClickEmailUnsubscribeResponseError =
  postV1OneClickEmailUnsubscribeResponse422 & {
    headers: Headers;
  };

export type postV1OneClickEmailUnsubscribeResponse =
  | postV1OneClickEmailUnsubscribeResponseSuccess
  | postV1OneClickEmailUnsubscribeResponseError;
