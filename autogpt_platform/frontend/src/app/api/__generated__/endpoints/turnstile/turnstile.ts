...
export type postV2VerifyTurnstileTokenResponseSuccess =
  postV2VerifyTurnstileTokenResponse200 & {
    headers: Headers;
  };
export type postV2VerifyTurnstileTokenResponseError =
  postV2VerifyTurnstileTokenResponse422 & {
    headers: Headers;
  };

export type postV2VerifyTurnstileTokenResponse =
  | postV2VerifyTurnstileTokenResponseSuccess
  | postV2VerifyTurnstileTokenResponseError;
