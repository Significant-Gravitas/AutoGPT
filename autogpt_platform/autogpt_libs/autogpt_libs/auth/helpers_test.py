...
class TestAuthHelpers:
    ...
    def test_add_auth_responses_to_openapi_basic(self):
    ...
    def test_add_auth_responses_to_openapi_with_security(self):
    ...
    def test_add_auth_responses_to_openapi_cached_schema(self):
    ...
    def test_add_auth_responses_to_openapi_existing_responses(self):
        ...
        if "/with-responses" in schema["paths"]:
            if "get" in schema["paths"]["/with-responses"]:
                responses = schema["paths"]["/with-responses"]["get"].get(
                    "responses", {}
                )
    ...
    def test_add_auth_responses_to_openapi_no_security_endpoints(self):
    ...
    def test_add_auth_responses_to_openapi_multiple_security_schemes(self):
    ...
    def test_add_auth_responses_to_openapi_empty_components(self):
    ...
    def test_add_auth_responses_to_openapi_all_http_methods(self):
    ...
    def test_bearer_jwt_auth_scheme_name(self):
        """Test that bearer_jwt_auth has the correct scheme name."""
        assert bearer_jwt_auth.scheme_name == "HTTPBearerJWT"
        assert bearer_jwt_auth.auto_error is False
        # HTTPBearer is initialized with bearerFormat but doesn't expose it as an attribute

    def test_add_auth_responses_with_no_routes(self):
    ...
    def test_custom_openapi_function_replacement(self):
    ...
    def test_endpoint_without_responses_section(self):
        ...
        with mock.patch("autogpt_libs.auth.helpers.get_openapi", mock_get_openapi):
            ...
            if "/no-responses" in schema["paths"]:
                if "get" in schema["paths"]["/no-responses"]:
                    responses = schema["paths"]["/no-responses"]["get"].get(
                        "responses", {}
                    )
    ...
    def test_components_with_existing_responses(self):
    ...
    def test_openapi_schema_persistence(self):
