...
def test_initial_values(config: Config):
    ...
    assert config.fast_llm_model == "gpt-3.5-turbo-16k-0613"
    assert config.smart_llm_model == "gpt-3.5-turbo-16k-0613"
...
def test_set_fast_llm_model(config: Config):
    ...
    config.set_fast_llm_model("gpt-3.5-turbo-16k-0613-test")
    assert config.fast_llm_model == "gpt-3.5-turbo-16k-0613-test"
