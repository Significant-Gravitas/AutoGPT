...
from autogpt.json_utils.json_fix_llm import fix_and_parse_json, fix_json_using_multiple_techniques
...
class TestFixJsonUsingMultipleTechniques:
    ...
    def test_fix_and_parse_json_can_not(self):
    ...
    def test_fix_and_parse_json_nested_objects(self):
        ...
        # Assert
        assert result == {"person": {"name": "John", "age": 30}, "hobbies": ["reading", "swimming"]}