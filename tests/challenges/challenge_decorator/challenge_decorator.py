...
CHALLENGE_FAILED_MESSAGE = "Challenges can sometimes fail randomly, please reach out to us on https://discord.gg/autogpt and reach out to us on the 'challenges' channel to let us know the challenge you're struggling with."
