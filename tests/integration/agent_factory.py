...
def browser_agent(agent_test_config, memory_none: NoMemory, workspace: Workspace):
    ...
    ai_config = AIConfig(
        ...
        ai_role="an AI designed to use the browse_website command to visit http://books.toscrape.com/catalogue/meditations_33/index.html, answer the question 'What is the price of the book?' and write the price to a file named \"browse_website.txt\", and use the task_complete command to complete the task.",  # noqa: E501
        ai_goals=[
            "Use the browse_website command to visit http://books.toscrape.com/catalogue/meditations_33/index.html and answer the question 'What is the price of the book?'",  # noqa: E501
...
def writer_agent(agent_test_config, memory_none: NoMemory, workspace: Workspace):
    ...
    ai_config = AIConfig(
        ...
        ai_role="an AI designed to use the write_to_file command to write 'Hello World' into a file named \"hello_world.txt\" and then use the task_complete command to complete the task.",  # noqa: E501
        ai_goals=[
...
def memory_management_agent(agent_test_config, memory_json_file, workspace: Workspace):
    ...
    ai_config = AIConfig(
        ...
        ai_role="an AI designed to read the instructions_1.txt file using the read_file method and follow the instructions in the file.",  # noqa: E501
        ai_goals=[
...
def get_company_revenue_agent(agent_test_config, memory_json_file, workspace: Workspace):
    ...
    ai_config = AIConfig(
        ...
        ai_goals=[
            "Write the revenue of Tesla in 2022 to a file. You should write the number without commas and you should not use signs like B for billion and M for million.",  # noqa: E501
        ],
    )
    ai_config.command_registry = command_registry
