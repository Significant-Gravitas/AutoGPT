...
| [Create Hey Gen Avatar Video](block-integrations/llm.md#create-hey-gen-avatar-video) | This block integrates with HeyGen to create avatar videos and retrieve their URLs |
