...
| [Github Compare Branches](block-integrations/github/repo.md#github-compare-branches) | This block compares two branches or commits in a GitHub repository |
...
| [Github Get Repository Tree](block-integrations/github/repo.md#github-get-repository-tree) | This block lists the entire file tree of a GitHub repository recursively |
...
| [Github List Commits](block-integrations/github/repo.md#github-list-commits) | This block lists commits on a branch in a GitHub repository |
...
| [Github Multi File Commit](block-integrations/github/repo.md#github-multi-file-commit) | This block creates a single commit with multiple file create/update/delete operations using the Git Trees API |
...
| [Github Search Code](block-integrations/github/repo.md#github-search-code) | This block searches for code in GitHub repositories |
