...
| [DeepSeek](block-integrations/llm.md#deepseek) | Execute chat and reasoning prompts with DeepSeek AI models (DeepSeek-V3 and DeepSeek-R1) and extract reasoning tokens |
