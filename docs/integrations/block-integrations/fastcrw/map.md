...
Blocks for mapping website structure and discovering all links using fastCRW.
<!-- END MANUAL -->

## Fast CRW Map Website

### What it is
fastCRW maps a website to extract all the links.

### How it works
<!-- MANUAL: how_it_works -->
This block uses fastCRW's mapping API to discover all links on a website without extracting full content. It quickly scans the site structure and returns a comprehensive list of URLs found.
