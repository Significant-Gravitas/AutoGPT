...
Blocks for crawling multiple pages of a website using fastCRW.
<!-- END MANUAL -->

## Fast CRW Crawl

### What it is
fastCRW crawls websites to extract comprehensive data while bypassing blockers.

### How it works
<!-- MANUAL: how_it_works -->
This block uses fastCRW's API to crawl multiple pages of a website starting from a given URL. It navigates through links, handling JavaScript rendering and bypassing anti-bot measures to extract clean content from each page.
