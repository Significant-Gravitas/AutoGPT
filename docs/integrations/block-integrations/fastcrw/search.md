...
Blocks for searching the web and extracting content using fastCRW.
<!-- END MANUAL -->

## Fast CRW Search

### What it is
fastCRW searches the web for the given query.

### How it works
<!-- MANUAL: how_it_works -->
This block uses fastCRW's search API to find web pages matching your query and optionally extract their content. It performs a web search and can return results with full page content in your chosen format.
