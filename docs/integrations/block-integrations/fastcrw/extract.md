...
Blocks for extracting structured data from web pages using fastCRW's AI extraction.
<!-- END MANUAL -->
...
### How it works
<!-- MANUAL: how_it_works -->
This block uses fastCRW's extraction API to pull structured data from web pages based on a prompt or schema. It crawls the specified URLs and uses AI to extract information matching your requirements.
