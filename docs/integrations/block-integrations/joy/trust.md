...
| min_trust_score | Minimum trust score required (0-5 scale). Default 1.5 | float | No |
| credentials | Joy API key (optional, increases rate limits) | credentials | No |

### Outputs

| Output | Description | Type |
|--------|-------------|------|
| meets_threshold | True if agent's trust score meets or exceeds the minimum | bool |
...
| badges | Earned badges (verified, responsive, etc.) | list |
| result | Complete agent profile | dict |
