...
Main goal: Describe the history location of the marbles.
...
After the AI processes the events and generates the history locations of each marbles, it writes these locations to an output file in JSON format.
