...
**Platform version:** `v0.6.51`

## Organize agents with drag-and-drop folders

Building on the folder support introduced in the previous release, you can now **drag and drop agents between folders**, rename folders, and color-code them to match your workflow. Whether you have five agents or fifty, everything stays tidy. [↗](https://github.com/Significant-Gravitas/AutoGPT/pull/12290)
