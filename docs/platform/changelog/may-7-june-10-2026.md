...
**Auto-discover MCP integrations** — when no native block exists for a tool or service, AutoPilot now automatically finds and connects the right MCP integration, so you never hit a dead end mid-workflow.

<figure><img src="../.gitbook/assets/autopilot-upgrades-hero.png" alt="AutoPilot chat showing scheduling, skills registry, and MCP auto-discovery"><figcaption><p>Native scheduling, a self-distilling skills registry, and MCP auto-discovery in AutoPilot</p></figcaption></figure>
