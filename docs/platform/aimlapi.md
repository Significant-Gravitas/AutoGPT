...
In the **LLM Model** dropdown, select the model currently available from AI/ML API:
...
> ✅ This model is available via the OpenAI-compatible API from [AI/ML API](https://aimlapi.com/app/?utm_source=autogpt&utm_medium=github&utm_campaign=integration)
