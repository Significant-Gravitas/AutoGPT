...
<pre><code><strong>backend/integrations/oauth/base.py
</strong>PROVIDER_NAME: ClassVar[ProviderName | str]
...
<pre><code><strong>backend/integrations/oauth/__init__.py
</strong># Build handlers dict with string keys for compatibility with SDK auto-registration
_ORIGINAL_HANDLERS = [
    DiscordOAuthHandler,
    GitHubOAuthHandler,
    GoogleOAuthHandler,
...
<pre><code><strong>backend/util/settings.py
</strong>github_client_id: str = Field(default="", description="GitHub OAuth client ID")
...
<pre><code><strong>frontend/src/components/integrations/credentials-input.tsx
</strong>--8 &#x3C;
...
<pre><code><strong>frontend/src/components/integrations/helper.ts
</strong>--8 &#x3C;
...
<pre><code><strong>frontend/src/lib/autogpt-server-api/types.ts
</strong>--8 &#x3C;
  --"autogpt_platform/frontend/src/lib/autogpt-server-api/types.ts:BlockIOCredentialsSubSchema";
</code></pre>

**Example: GitHub integration**[**¶**](https://docs.agpt.co/platform/new_blocks/#example-github-integration)
...
<pre><code><strong>backend/blocks/github/issues.py
</strong>class GithubCommentBlock(Block):
    class Input(BlockSchemaInput):
...
<pre><code><strong>backend/integrations/oauth/google.py
</strong>class GoogleOAuthHandler(BaseOAuthHandler):
    """
...
<pre><code><strong>backend/blocks/google/_auth.py
</strong>secrets = Secrets()
...
**Adding a Webhooks Manager**[**¶**](https://docs.agpt.co/platform/new_blocks/#adding-a-webhooks-manager)
...
<pre><code><strong>backend/integrations/webhooks/_base.py
</strong>PROVIDER_NAME: ClassVar[ProviderName]
...
<pre><code><strong>backend/integrations/webhooks/__init__.py
</strong>@cached(ttl_seconds=3600)
...
**Example: GitHub Webhook Integration**[**¶**](https://docs.agpt.co/platform/new_blocks/#example-github-webhook-integration)
...
<pre><code><strong>backend/util/request.py
</strong># IPv4 Ranges
...
## Blocks we want to see <a href="#blocks-we-want-to-see" id="blocks-we-want-to-see"></a>
...
### Consumer Services/Platforms <a href="#consumer-servicesplatforms" id="consumer-servicesplatforms"></a>
...
### E-commerce <a href="#e-commerce" id="e-commerce"></a>
...
### Business Tools <a href="#business-tools" id="business-tools"></a>
...
## Agent Templates we want to see <a href="#agent-templates-we-want-to-see" id="agent-templates-we-want-to-see"></a>

### Data/Information <a href="#datainformation" id="datainformation"></a>
