...
CREATE TABLE "AgentNode" (
    ...
    CONSTRAINT "AgentNode_agentGraphId_agentGraphVersion_fkey" FOREIGN KEY ("agentGraphId", "agentGraphVersion") REFERENCES "AgentGraph" ("graph_id", "version") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "AgentGraphExecution" (
    ...
    "agentGraphId" TEXT NOT NULL,
    "agentGraphVersion" INTEGER NOT NULL,
    CONSTRAINT "AgentGraphExecution_agentGraphId_agentGraphVersion_fkey" FOREIGN KEY ("agentGraphId", "agentGraphVersion") REFERENCES "AgentGraph" ("graph_id", "version") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "AgentGraphExecutionSchedule" (
    ...
    CONSTRAINT "AgentGraphExecutionSchedule_agentGraphId_agentGraphVersion_fkey" FOREIGN KEY ("agentGraphId", "agentGraphVersion") REFERENCES "AgentGraph" ("graph_id", "version") ON DELETE RESTRICT ON UPDATE CASCADE
);
