...
- 🔮 Observability Monitor for API Usage by new relic
...
## (Optional) 🔮 Observability Monitor for API Usage by new relic
Monitor OpenAI GPT application usage in [New Relic](https://github.com/newrelic/nr-openai-observability#eu-account-users)
